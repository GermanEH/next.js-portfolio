...
const Projects:React.FC<SectionProps> = ({dictionary}) => {
  ...
  return (
    <>
      {isVisible && 
      <div className={`absolute lg:max-w-5xl lg:w-full pl-20 pt-12 mt-[28vh] mobile-s:mt-[32vh] mobile-s:mr-[18vw] sm:mt-[36vh] mobile-hd:mt-[44vh] mobile-hd:ml-[15vw] md:mt-[56vh] lg:mt-[34vh] desktop-hd:mt-[32] xl:mt-[28vh] desktop-full-hd:mt-[34vh] z-20 transition-opacity opacity-${isVisible ? '100' : '0'} duration-1000 flex flex-wrap lg:max-xl:scale-75 lg:max-xl:ml-[20vw] `}>
