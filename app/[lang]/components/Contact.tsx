...
const Contact:React.FC<SectionProps> = ({dictionary}) => {
  ...
  return (
    <>
    {isVisible  && 
      <div className={`absolute lg:max-w-5xl lg:w-full ml-20 lg:ml-0 p-4 mt-[28vh] mobile-s:mt-[40vh] mobile-s:mr-[20vw] sm:mt-[44vh] mobile-hd:mt-[50vh] md:mt-[56vh] lg:mt-[34vh] desktop-hd:mt-[26vh] xl:mt-[28vh] desktop-full-hd:mt-[34vh] z-20 transition-opacity opacity-${isVisible ? '100' : '0'} duration-1000 items-center lg:grid lg:grid-cols-2 items-center`}>
        ...
        <section className='flex flex-col justify-center items-center'>
        <h2 className="text-xl font-bold mt-16 lg:mt-0 mb-4 mobile-s:mt-4">{dictionary?.section_3_body_1}</h2>
