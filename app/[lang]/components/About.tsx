...
const About:React.FC<SectionProps> = ({dictionary}) => {
  ...
  return (
    <>
    {isVisible && 
      <div className={`absolute lg:max-w-5xl lg:w-full p-4 mt-[28vh] mobile-s:mt-[36vh] sm:mt-[20vh] mobile-hd md:mt-[56vh] lg:mt-[34vh] xl:mt-[28vh] desktop-full-hd:mt-[25vh] ml-8 z-20 transition-opacity opacity-${isVisible ? '100' : '0'} duration-1000`}>
