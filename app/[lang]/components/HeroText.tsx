...
export default function HeroText({title_1, title_2}: title) {
  ...
  return (
    <>
      <div className="max-w-5xl w-full items-center font-mono lg:flex mobile-s:max-sm:scale-[80%]">
        ...
        <p className="text-8xl left-0 top-0 flex w-full lg:static lg:w-auto p-4 lg:px-28 mobile-m:pl-8 sm:pl-24">
          {title_1}
        </p>
        {/* <div className="fixed bottom-0 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:h-auto lg:w-auto lg:bg-none">
        </div> */}
      </div>
      <div className="w-full max-w-5xl pb-16 mobile-s:pb-0 mobile-l:pr-16 mobile-hd:max-lg:px-20 mobile-s:max-sm:scale-[80%]">
